...
1 проект в Академии Бэкенда Т-банк 2024.
Представляет собой консольное приложение - игру "Виселица"
...
Для начала работы нужно склонировать себе данный репозиторий, загрузить все необходимые зависимости и запустить приложение
