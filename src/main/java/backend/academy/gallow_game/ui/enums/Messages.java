...
public enum Messages {
    ...
    RULES("""
        ...
        Игрок называет букву:
          1) буква есть в загаданном слове - все прочерки, соответствующие букве в слове, заменяются на введенную букву;
          2) буквы нет в загаданном слове -  дорисовывается один элемент виселицы.
